      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        ...
        <section className="lg:col-span-4 bg-white rounded-xl border border-slate-150 shadow-md flex flex-col h-full min-h-[500px]" data-testid={TEST_IDS.annotationAnswerPanel}>
          <div className="px-4 py-3 bg-slate-50 border-b border-slate-150 flex items-center justify-between">
            <h3 className="font-extrabold text-slate-800 text-xs uppercase tracking-wide">1. Văn Bản Trợ Giúp (Context)</h3>
          ...
          <div className="p-4 space-y-4 flex-1 overflow-auto">
            ...
            <div className="space-y-1 pt-2 border-t border-slate-100">
              <span className="text-slate-400 text-[11px] uppercase tracking-wider font-extrabold block">Câu Trả Lời (Answer Context):</span>
        ...
        <section className="lg:col-span-4 bg-white rounded-xl border border-slate-150 shadow-md flex flex-col h-full min-h-[500px]" data-testid={TEST_IDS.annotationScoringPanel}>
          <div className="px-4 py-3 bg-slate-50 border-b border-slate-150 flex items-center justify-between col-span-2">
            <h3 className="font-extrabold text-slate-800 text-xs uppercase tracking-wide">2. Nhận Định & Tiêu Chí (Claim)</h3>
          ...
          <div className="p-4 space-y-4 flex-1 overflow-auto">
            ...
            <div className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 space-y-2.5">
              <div className="flex justify-between items-center">
                <strong className="text-xs text-slate-800 font-bold block">Nội dung nhận định (Claim Text)</strong>
                <button
                  onClick={() => {
          ...
          <div className="p-4 space-y-4 flex-1 overflow-auto">
            ...
            <div className="pt-3 border-t border-slate-150 space-y-2">
              ...
              <div className="p-3 bg-slate-50 border border-slate-150 rounded-xl leading-relaxed text-slate-600 text-[11px] md:text-[11.5px] max-h-[150px] overflow-y-auto space-y-2" data-testid={TEST_IDS.annotationReferenceContent}>
                {activeRefTab === "rubric" && (
                  <>
                    <p><strong>SF (Sự thật):</strong> Đánh giá tính chân thực tuyệt đối của nội dung nhận định so với bối cảnh xã hội và tri thức.</p>
                    <p><strong>SC (Nguồn hỗ trợ):</strong> Điểm số đối chiếu trực tiếp xem các văn bản gốc có thực sự chứng minh nhận định hay không.</p>
                    <p><strong>NH (Không gây hại):</strong> Đánh giá mức độ lành mạnh, không bóp méo thông tin hay gây ảnh hưởng xấu.</p>
                    <p><strong>SQ (Chất lượng nguồn):</strong> Độ tin cậy của nhà xuất bản (Tier 1 vs Tier 3).</p>
