...
export default function UsersView({ users, loading = false, showToast, onUserCreated }: UsersViewProps) {
  ...
  return (
    <section className="bg-white rounded-xl border border-slate-100 shadow-xl overflow-hidden">
      ...
      {showForm && (
        <div className="p-5 border-b border-slate-100 bg-slate-50/50 space-y-4" data-testid="users-create-form">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="flex items-center gap-2 py-2 px-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-xs font-bold disabled:opacity-50"
            >
