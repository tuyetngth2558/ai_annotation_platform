...
**Trạng thái:** Scope baseline cho MVP
...
| 9 | Design rộng, build hẹp: data model và tài liệu phải support mở rộng audio, image về sau |
...
- Policy Center và guideline editor.
- In-app notification.
- Risk-based sampling engine.
- IAA tự động và Gold standard injection.
...
- Scope MVP 4 tuần (build now / design now / build later).
- Context Diagram.
- Use Case Diagram.
...
- ERD có khả năng mở rộng.
- Data Dictionary.
- Feature list ưu tiên + User Stories.
...
- Setup và duy trì môi trường phát triển và staging.
...
- Project setup / PDF bundle upload.
- Annotator workspace.
- QA review.
